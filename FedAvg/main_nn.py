...
if __name__ == '__main__':
    ...
    print("net_glob have {} paramerters in total".format(sum(x.numel() for x in net_glob.parameters())))
    print(net_glob)
    ...
    plt.savefig(
        save_folder+'nprox_kindacc_atttype{}_cloudagg{}_gamma{}_user{}_attuser{}_{}_{}_{}_{}_users{}_attackers_{}_attackep_{}_MAX_GRAD_NORM{}_NOISE_MULTIPLIER{}_thresh_{}_iid{}.png'.format(args.attackertype, args.cloudagg, args.gamma1, args.num_users, args.num_attackers, args.agg,args.dataset,
    ...
    plt.savefig(save_folder+'nprox_loss_atttype{}_cloudagg{}_gamma{}_user{}_attuser{}_{}_{}_{}_{}_C{}_MAX_GRAD_NORM{}_NOISE_MULTIPLIER{}_iid{}.png'.format(args.attackertype, args.cloudagg, args.gamma1, args.num_users, args.num_attackers, args.agg, args.dataset, args.model, args.epochs, args.frac, args.max_grad_norm, args.noise_multiplier, args.iid))

    # plot acc curve
    plt.figure()
    plt.plot(range(len(test_acc_plot)), test_acc_plot)
    plt.ylabel('test_acc')
    plt.savefig(save_folder+'nprox_totalacc_atttype{}_cloudagg{}_gamma{}_user{}_attuser{}_{}_{}_{}_{}_C{}_MAX_GRAD_NORM{}_NOISE_MULTIPLIER{}_iid{}.png'.format(args.attackertype, args.cloudagg, args.gamma1, args.num_users, args.num_attackers, args.agg, args.dataset, args.model, args.epochs, args.frac, args.max_grad_norm, args.noise_multiplier, args.iid))
    ...
    if args.is_backdoor:
        ...
        plt.savefig(
            save_folder+'nprox_backdoor_accs_atttype{}_cloudagg{}_gamma{}_user{}_attuser{}_{}_{}_{}_{}_users{}_attackers_{}_attackep_{}_thresh_{}_MAX_GRAD_NORM{}_NOISE_MULTIPLIER{}_iid{}.png'.format(args.attackertype, args.cloudagg, args.gamma1, args.num_users, args.num_attackers, args.agg,args.dataset,
                                                                                                         args.model,
                                                                                                         args.epochs,
                                                                                                         args.num_users - args.num_attackers,
                                                                                                         args.num_attackers,
